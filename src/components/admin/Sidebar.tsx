...
const navSections: NavSection[] = [
    ...
    },
    {
        label: "Konten",
        items: [
            { title: "Artikel", href: "/admin/articles", icon: Newspaper, badge: "24" },
            { title: "Kategori", href: "/admin/categories", icon: FolderOpen },
            { title: "Komentar", href: "/admin/comments", icon: MessageSquare, badge: "5", badgeVariant: "destructive" },
                ...
                <Tooltip key={item.title} delayDuration={0}>
                    ...
                    <TooltipContent side="right" sideOffset={8}>
                        <div className="flex items-center gap-2">
                            {item.title}
                            {item.badge && (
                                <Badge variant={item.badgeVariant || "secondary"} className="h-4 px-1 text-[10px]">
                                    {item.badge}
                                </Badge>
                            )}
                        </div>
                    ...
                    {!collapsed ? (
                        <Link href="/admin" className="flex items-center gap-2 px-1">
                            ...
                            <div className="min-w-0">
                                <p className="text-sm font-semibold leading-none truncate">BeritaAE</p>
                                <p className="text-[10px] text-muted-foreground leading-none mt-0.5">Admin</p>
                            </div>
                        </Link>
                    ) : (
                        <Link href="/admin" className="mx-auto flex h-7 w-7 items-center justify-center rounded-md bg-primary">
                            <span className="text-xs font-bold text-primary-foreground">B</span>
                        </Link>
                    )}
                    {!collapsed && (
