          ...
          <div className="relative h-44 overflow-hidden">
            ...
            <div className="absolute bottom-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
              <button
                type="button"
                title="Simpan"
                className="p-2 rounded-full bg-white/90 dark:bg-black/70 backdrop-blur-md shadow-lg hover:scale-110 transition-transform"
              >
        ...
        <div className="relative h-full min-h-[350px] rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <Badge className="backdrop-blur-md bg-white/20 text-white font-semibold border-0 shadow-lg">
                {category.name}
              </Badge>
            </div>
