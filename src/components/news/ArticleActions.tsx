                ...
                <CardContent className="p-3">
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center bg-muted rounded-full p-1">
                            <Button
                                ...
                                className={cn(
                                    ...
                                    userReaction === "like" && "bg-green-500/20 text-green-600 hover:bg-green-500/30"
                                )}
                                onClick={handleLike}
                            >
                                <motion.div
                            ...
                            <Button
                                ...
                                className={cn(
                                    "h-9 px-4 rounded-full gap-2 transition-all",
                                    userReaction === "dislike" && "bg-red-500/20 text-red-600 hover:bg-red-500/30"
                                )}
                                onClick={handleDislike}
                            >
                                <motion.div
                                    animate={{ scale: userReaction === "dislike" ? [1, 1.3, 1] : 1 }}
                                    transition={{ duration: 0.2 }}
                                >
                        ...
                        >
                            ...
                            <span className="hidden sm:inline text-muted-foreground">Komentar</span>
                        </Button>
                        ...
                        <div className="relative">
                            ...
                            <AnimatePresence>
                                {showShare && (
                                    ...
                                    >
                                        <p className="text-xs font-medium text-muted-foreground mb-3">Bagikan via</p>
                                        <div className="grid grid-cols-4 gap-2 mb-3">
                                            <Button variant="outline" size="icon" className="h-10 w-10 rounded-xl hover:bg-blue-500/10 hover:text-blue-500 hover:border-blue-500">
                                                <Facebook className="h-4 w-4" />
                                            </Button>
                                            <Button variant="outline" size="icon" className="h-10 w-10 rounded-xl hover:bg-sky-500/10 hover:text-sky-500 hover:border-sky-500">
                                                <Twitter className="h-4 w-4" />
                                            </Button>
                                            <Button variant="outline" size="icon" className="h-10 w-10 rounded-xl hover:bg-green-500/10 hover:text-green-500 hover:border-green-500">
