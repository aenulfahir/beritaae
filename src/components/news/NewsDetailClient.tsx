...
export function NewsDetailClient({ article, relatedArticles, categories }: NewsDetailClientProps) {
                        ...
                        <CardContent className="p-6">
                            <div className="grid grid-cols-3 gap-4 text-center">
                                <div className="p-4 rounded-xl bg-background shadow-sm">
                                    ...
                                    <p className="text-2xl font-bold">{article.views_count.toLocaleString()}</p>
