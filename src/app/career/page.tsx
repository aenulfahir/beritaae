...
export const metadata: Metadata = {
    title: "Karir",
    description: "Bergabung dengan tim BeritaAE - Bangun karir di industri media digital terdepan Indonesia.",
};

export default function CareerPage() {
    const benefits = [
        { icon: Heart, title: "Health Insurance", desc: "Asuransi kesehatan untuk karyawan & keluarga" },
        { icon: Coffee, title: "Free Snacks", desc: "Kopi, teh, dan camilan gratis setiap hari" },
        { icon: Laptop, title: "WFH Friendly", desc: "Fleksibilitas kerja dari rumah" },
        { icon: GraduationCap, title: "Learning Budget", desc: "Anggaran pengembangan skill setiap tahun" },
    ];
                    ...
                    <ScrollReveal>
                        <div className="max-w-3xl">
                            ...
                            <p className="text-lg text-muted-foreground mb-8">
                                Bergabung dengan tim passionate yang berdedikasi menyajikan berita
                                berkualitas untuk jutaan pembaca Indonesia.
                            </p>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    ...
                    <div className="space-y-4 max-w-4xl mx-auto">
                        {jobs.map((job, index) => (
                            <ScrollReveal key={job.title} delay={index * 0.05}>
                                <Card className="border-0 shadow-lg hover:shadow-xl transition-all group cursor-pointer">
                                    <CardContent className="p-6">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                            ...
                                            <Button variant="outline" className="shrink-0 group-hover:bg-green-500 group-hover:text-white group-hover:border-green-500 transition-colors">
                                                Apply Now
                                            </Button>
                                        </div>
                                    </CardContent>
                        ...
                        <Card className="border-0 shadow-2xl bg-gradient-to-r from-green-500 to-emerald-500 text-white max-w-3xl mx-auto">
                            <CardContent className="p-8 text-center">
                                ...
                                <p className="text-white/80 mb-6">
                                    Kirimkan CV Anda dan kami akan menghubungi jika ada posisi yang sesuai.
                                </p>
