...
import { getTrendingArticles } from "@/lib/supabase/services/articles-server";
import {
  ScrollReveal,
  StaggerContainer,
  StaggerItem,
...
export default async function PopularPage() {
  // Fetch popular articles from Supabase (sorted by views_count)
  const popularNews = await getTrendingArticles(20);
